...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/20190528-names-19">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20190528-names-19/",
      "url": "http://static.startribune.com/news/projects-staging/all/20190528-names-19/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20190528-names-19/",
      "url": "http://static.startribune.com/news/projects/all/20190528-names-19/"
    }
  }
}
```
